...
@interface SGURegisterView()<UITextFieldDelegate>
...
@end
@implementation SGURegisterView
...
- (void)layoutSubviews {
    ...
    _userRgTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sgu_ic_login_user"]];
    ...
    _pwdRgTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sgu_ic_login_password"]];
    ...
    _surePwdTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sgu_ic_login_password"]];
    ...
    UIImageView *lineImageView3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sgu_icon_login_shortline"]];
