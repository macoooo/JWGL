...
@interface SGULoginView()<UITextFieldDelegate>

@property (nonatomic, strong) UIButton *registerButton;
@property (nonatomic, strong) UIImageView *logoImageView;

@end
@implementation SGULoginView
...
- (void)layoutSubviews {
    ...
    _usersTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sgu_ic_login_user"]];
    ...
    _passwordTextField.leftView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"sgu_ic_login_password"]];
    ...
    [_loginButton setImage:[UIImage imageNamed:@"sgu_bt_login"] forState:UIControlStateNormal];
